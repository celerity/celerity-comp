...
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/vecadd.cl -o samples/vecadd.bc
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/2mm.cl -o samples/2mm.bc
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/3mm.cl -o samples/3mm.bc
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/coalesced.cl -o samples/coalesced.bc
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/kmeans.cl -o samples/kmeans.bc
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/softmax_loss.cl -o samples/softmax_loss.bc
clang-12 -S -x cl -emit-llvm -cl-std=CL2.0 -Xclang -finclude-default-header samples/parboil.cl -o samples/parboil.bc
clang-12 -S -emit-llvm samples/simple_loop.c -o samples/simple_loop.bc
